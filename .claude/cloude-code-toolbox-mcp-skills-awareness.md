...
_Generated: 2026-05-15T04:35:50.652Z_
...
Workspace `mcp.json` _(folder: rm_homework)_

- **c:\Users\MAC\Desktop\rm_homework\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\MAC\.claude.json** — _File missing_
